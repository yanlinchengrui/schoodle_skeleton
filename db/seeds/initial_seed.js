  ...
  return knex('participants').del()
    ...
    .then(() => {
      return Promise.all([
        ...
        knex('events')
          .insert([{host_id: 1, event_name: 'Peter""s Party!', event_url: 'random website', votes_to_win: 2, description: 'Party time', date_1: '2019-04-02', date_2: '2019-04-03', date_3: '2019-04-04', date_4: '2019-04-05', date_5: '2019-04-06', chosen_date: '2019-04-05'}, {host_id: 2, event_name: 'Phil""s Party!', event_url: 'random_website_1', votes_to_win: 2, description: 'More party time', date_1: '2019-05-02', date_2: '2019-05-03', date_3: '2019-05-04', date_4: '2019-05-05', date_5: '2019-05-06', chosen_date: '2019-05-05'},
          {host_id: 3, event_name: 'Govind""s Party!', event_url: 'random_website_2', votes_to_win: 2, description: 'The most party time', date_1: '2019-06-02', date_2: '2019-06-03', date_3: '2019-06-04', date_4: '2019-06-05', date_5: '2019-06-06', chosen_date: '2019-06-05'}
        ]),
